/**
 * Country data for phone number formatting
 *
 * Country model:
 * [
 *    Country name,
...
const rawAllCountries: CountryRawData[] = [
...
const allCountries: CountryItem[] = rawAllCountries.flatMap(
  (country): CountryItem[] => {
    ...
    const countryItem: CountryItem = {
      ...
      hasAreaCodes: areaCodes !== undefined,
    };

    const areaItems: CountryItem[] = [];

    if (areaCodes) {
      areaCodes.forEach((areaCode): void => {
